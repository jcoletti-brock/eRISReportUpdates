...
**Analysis Date:** February 18, 2026 04:15 PM
...
Add an entry to the lookup table for the missing tag:
- `hist_tagname`: MTPSVR1.KIWOL03TT.F_CV
- `ign_tagprovider`: The appropriate Ignition tag provider for this tag
